<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="favorilerim.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.favoilerim" %>
...
<div class="banner-top">
	<div class="container">
		<h3 >Favorileriniz</h3>
		<h4><a href="index.aspx">Anasayfa</a><label>/</label>Favoriler</h4>
		<div class="clearfix"> </div>
	</div>
</div>
 ...
 <table class="table ">
		  <tr>
			<th class="t-head head-it ">Ürünler</th>
			<th class="t-head">Fiyat</th>
		<th class="t-head">Adet</th>

			<th class="t-head">Satın Al</th>
		  </tr>
		  <tr class="cross">
			<td class="ring-in t-data">
				<a href="index.aspx" class="at-in">
			...
			<td class="t-data t-w3l"><a class=" add-1" href="index.aspx">Sepete Ekle</a></td>
			
		  </tr>
		  <tr class="cross1">
		  <td class="t-data ring-in"><a href="index.aspx" class="at-in"><img src="images/wi1.png" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>Sed ut perspiciatis unde</h5>
			</div>
			<div class="clearfix"> </div>
		...
		<td class="t-data"><div class="quantity"> 
		  ...
		  <tr class="cross2">
		  <td class="t-data ring-in"><a href="index.aspx" class="at-in"><img src="images/wi2.png" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>Sed ut perspiciatis unde</h5>
			</div>
			<div class="clearfix"> </div>
			...
			<td class="t-data"><a class=" add-1" href="index.aspx">Sepete Ekle</a></td>
