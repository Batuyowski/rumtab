<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haberler.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.haberler" %>
			 ...
			 <div class="col-md-6">
				<nav>
				  <ul class="pagination">
					...
					<li class="active"><a href="haberler.aspx">1 <span class="sr-only">(current)</span></a></li>
