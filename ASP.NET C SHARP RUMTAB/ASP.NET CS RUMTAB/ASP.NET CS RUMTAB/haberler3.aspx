<a href="giris.aspx">giris.aspx</a>
<a href="giris.aspx.cs">giris.aspx.cs</a>
<a href="giris.aspx.designer.cs">giris.aspx.designer.cs</a><%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haberler3.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.haberler3" %>
...
<div class="typrography">
	 <div class="container">
        ...
        <asp:Label ID="Label1" runat="server" Text="Başlık" Font-Size="XX-Large" BorderStyle="Groove" Font-Names="COCOGOOSE" BackColor="#FAB005" ForeColor="White" Width="900px"></asp:Label><br />
			 ...
			 <asp:Image ID="Image2" runat="server" ImageAlign="Middle" ImageUrl="~/arkaplan/haberler_banner.png" Width="1127px" />
		</div>
         <div class="spec "
			 <div class="col-md-6">
				<nav>
				  <ul class="pagination">
					<li class="enabled"><a href="haberler2.aspx" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
					<li><a href="haberler.aspx">1 </a></li>
					<li><a href="haberler2.aspx">2</a></li>
					<li class="active"><a href="haberler3.aspx">3<span class="sr-only">(current)</span></a></li>
					...
					<li><a href="haberler8.aspx">8</a></li>
