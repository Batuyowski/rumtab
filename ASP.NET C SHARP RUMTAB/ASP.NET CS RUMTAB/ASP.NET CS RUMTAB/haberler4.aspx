<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haberler4.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.haberler4" %>
		...
		<div class="main-icerik">
         ...
         <div class="spec "
			 <div class="col-md-6">
				<nav>
				  <ul class="pagination">
					<li class="enabled"><a href="haberler3.aspx" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
					<li><a href="haberler.aspx">1</a></li>
					<li><a href="haberler2.aspx">2</a></li>
					<li><a href="haberler3.aspx">3</a></li>
					<li class="active"><a href="haberler4.aspx">4<span class="sr-only">(current)</span></a></li>
