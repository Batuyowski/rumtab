<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haberler5.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.haberler5" %>
		...
		<div class="main-icerik">
         ...
         <div class="spec "
			 <div class="col-md-6">
				<nav>
				  <ul class="pagination">
					<li class="enabled"><a href="haberler4.aspx" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
					...
					<li class="active"><a href="haberler5.aspx">5<span class="sr-only">(current)</span></a></li>
