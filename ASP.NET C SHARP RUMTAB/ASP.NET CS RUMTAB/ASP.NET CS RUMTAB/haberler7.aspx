<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haberler7.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.haberler7" %>
		...
		<div class="main-icerik">
         ...
         <div class="spec "
			 <div class="col-md-6">
				<nav>
				  <ul class="pagination">
					<li class="enabled"><a href="haberler6.aspx" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
					...
					<li class="active"><a href="haberler7.aspx">7<span class="sr-only">(current)</span></a></li>
