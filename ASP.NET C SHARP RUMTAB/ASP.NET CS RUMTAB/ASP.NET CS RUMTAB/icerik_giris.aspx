<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="icerik_giris.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.icerik_giris" %>
<!DOCTYPE html>
...
<!-- Custom Theme files -->
<link rel="stylesheet" href="css/style.css("~/Content/style.css")" type="text/css" />
...
<div class="banner-top">
	<div class="container">
		<h3 >İçerik Üreticileri Giriş Paneli</h3>
		<h4><a href="index.aspx">Haber</a><label>/</label>Yetkili Girişi Yap</h4>
		<div class="clearfix"> </div>
	</div>
</div>
<!--login-->
		...
		<div class="main-agileits">
				<div class="form-w3agile">
					...
					<form id="form1" runat="server">
						<div class="key">
							<i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                            <div class="clearfix">
                            </div>
						</div>
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>&nbsp;<asp:TextBox ID="TextBox2" runat="server" TextMode="Password"></asp:TextBox>
                            <div class="clearfix">
                            </div>
						</div>
						&nbsp;<asp:Button ID="Button1" runat="server" Text="Giriş" OnClick="Button1_Click1" />
                        <asp:Label ID="Label1" runat="server"></asp:Label>
                    </form>
				</div>
				<div class="forg">
					<a href="#" class="forg-left">Bir içerik üreticisi değilseniz bu sayfaya erişim sağlayamazsınız.</a>
				<div class="clearfix"></div>
				</div>
			</div>
		</div>
