						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								<div class="col-m">								
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">1250 VP</a></h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">600 VP</a></h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">8400 VP</a></h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">2400 VP</a></h6>							
										</div>
										<div class="mid-2">
						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Steam</a>(Random Key)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Steam</a>(Gold Key)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>₺1.00</label><em class="item_price">₺0.70</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Steam</a>(Diamond Key)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Steam</a>(Ultimate Key)</h6>							
										</div>
										<div class="mid-2">
						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								...
								<a href="#" data-toggle="modal" data-target="#myModal9" class="haber_ekle-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Riot Games</a>(400 RP)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Riot Games</a>(840 RP)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>₺1.00</label><em class="item_price">₺0.70</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx"> Riot Games</a>(1780 RP)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>₺2.00</label><em class="item_price">₺1.00</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Riot Games</a>(3620 RP)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>₺4.00</label><em class="item_price">₺3.50</em></p>
											  <div class="block">
					...
					<div class="tab-pane text-style" id="tab4">
							...
							<div class="col-md-3 m-wthree">
								...
								<a href="#" data-toggle="modal" data-target="#myModal13" class="haber_ekle-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Honey</a>(500 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m ">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Chocos</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m ">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Oats</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>₺4.00</label><em class="item_price">₺3.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="index.aspx">Bread</a>(500 g)</h6>							
										</div>
										<div class="mid-2">
