...
{
    public partial class spckey : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            komut.CommandText = "select * from urunler where urun_id=1";
            ...
            komut2.CommandText = "select * from urunler where urun_id=2";
            ...
            komut3.CommandText = "select * from urunler where urun_id=3";
            ...
            komut4.CommandText = "select * from urunler where urun_id=4";
            ...
            komut5.CommandText = "select * from urunler where urun_id=5";
            ...
            komut6.CommandText = "select * from urunler where urun_id=6";
            ...
            komut7.CommandText = "select * from urunler where urun_id=7";
            ...
            komut8.CommandText = "select * from urunler where urun_id=8";
            ...
            komut9.CommandText = "select * from urunler where urun_id=9";
            ...
            komut10.CommandText = "select * from urunler where urun_id=10";
            ...
            komut11.CommandText = "select * from urunler where urun_id=11";
            ...
            komut12.CommandText = "select * from urunler where urun_id=12";
            ...
            SqlConnection baglanti13 = new SqlConnection(@"Data Source=DESKTOP-IL5TFFJ\WOLVOX8;Initial Catalog=rumtab;Integrated Security=True");
            SqlCommand komut13 = new SqlCommand();
            baglanti13.Open();
            komut13.Connection = baglanti13;
            komut13.CommandText = "select * from urunler where urun_id=13";

            komut13.ExecuteNonQuery();
            SqlDataReader dr13 = komut13.ExecuteReader();
            if (dr13.Read())
            {
                TextBox25.Text = dr13["urun_adi"].ToString();
                TextBox26.Text = dr13["urun_fiyati"].ToString();
                baglanti13.Close();
            }
        }
    }
