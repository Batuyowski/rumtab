<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bilgiler.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.bilgiler" %>
	...
	<div class="container">
		...
		<div class="head-t">
			<ul class="card">
				...
				<li><a href="bilgiler.aspx"><i class="fa fa-user" aria-hidden="true"></i>Bilgilerim</a></li>
				<li><a href="indirimler.aspx"><i class="fa fa-arrow-right" aria-hidden="true"></i>İndirimler</a></li>
...
<div class="banner-top">
	<div class="container">
		...
		<h4><a href="index.aspx">Anasayfa</a><label>/</label>Kişisel Bilgiler</h4>
		<div class="clearfix"> </div>
	</div>
</div>
<!-- typography -->
		...
		<div class="auto-style3">
				<div class="form-w3agile">
					...
					<div class="key">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Bilgileri Kaydet" Width="153px" />
                        <asp:Button ID="Button2" runat="server" Text="Bilgileri Güncelle" Width="153px" />
                        <asp:Button ID="Button4" runat="server" Text="Kart Bilgilerim" Width="153px" />
                        <asp:Button ID="Button3" runat="server" Text="Hesabımı Sil" Width="153px" />
...
<div class="footer">
	<div class="container">
		...
		<div class="col-md-3 footer-grid">
			<h3>Hesabım</h3>
			<ul>
				<li><a href="bilgiler.aspx">Giriş</a></li>
				<li><a href="indirimler.aspx">Kayıt</a></li>
