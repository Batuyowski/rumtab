<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haberler6.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.haberler6" %>
		...
		<div class="main-icerik">
         ...
         <div class="spec "
			 <div class="col-md-6">
				<nav>
				  <ul class="pagination">
					<li class="enabled"><a href="haberler5.aspx" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
					...
					<li class="active"><a href="haberler6.aspx">6<span class="sr-only">(current)</span></a></li>
