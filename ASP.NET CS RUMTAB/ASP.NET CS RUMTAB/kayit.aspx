<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kayit.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.kayit" %>
...
<div class="banner-top">
	<div class="container">
		<h3 >Kayıt Ol</h3>
		<h4><a href="index.aspx">Anasayfa</a><label>/</label>Kayıt Ol</h4>
		<div class="clearfix"> </div>
	</div>
</div>
		...
		<div class="main-agileits">
				<div class="form-w3agile form1">
					...
					<form id="form1" runat="server">
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>&nbsp;<asp:TextBox ID="TextBox1" runat="server" Height="16px" Width="146px"></asp:TextBox>
                            <div class="clearfix">
                            </div>
						</div>
						<div class="key">
							<i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;<asp:TextBox ID="TextBox2" runat="server" Height="16px" Width="146px"></asp:TextBox>
                            <div class="clearfix">
                            </div>
						</div>
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>&nbsp;<asp:TextBox ID="TextBox3" runat="server" Height="16px" Width="146px" TextMode="Password"></asp:TextBox>
                            <div class="clearfix">
                            </div>
						</div>
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>&nbsp;<asp:TextBox ID="TextBox4" runat="server" Height="16px" Width="146px" TextMode="Password"></asp:TextBox>
