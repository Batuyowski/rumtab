<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sgiyimaksesuar.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.sgiyimaksesuar" %>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="skonsol.aspx"><img class="first-slide" src="images/ba2.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="skonsol.aspx"><img class="second-slide " src="images/ba.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
         <a href="sgiyimaksesuar.aspx"> <img class="third-slide " src="images/ba1.jpg" alt="Third slide"></a>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="49" data-name="Safety Pins" data-summary="summary 49" data-price="9.00" data-quantity="1" data-image="images/database_error.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
