...
{
    public partial class sgiyimaksesuar : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            komut.CommandText = "select * from urunler where urun_id=27";
            ...
            komut2.CommandText = "select * from urunler where urun_id=28";
            ...
            komut3.CommandText = "select * from urunler where urun_id=29";
            ...
            komut4.CommandText = "select * from urunler where urun_id=30";
            ...
            komut5.CommandText = "select * from urunler where urun_id=31";
            ...
            komut6.CommandText = "select * from urunler where urun_id=32";
            ...
            komut7.CommandText = "select * from urunler where urun_id=33";
            ...
            komut8.CommandText = "select * from urunler where urun_id=34";
            ...
            komut9.CommandText = "select * from urunler where urun_id=35";
            ...
            komut10.CommandText = "select * from urunler where urun_id=36";
            ...
            komut11.CommandText = "select * from urunler where urun_id=37";
            ...
            komut12.CommandText = "select * from urunler where urun_id=38";
