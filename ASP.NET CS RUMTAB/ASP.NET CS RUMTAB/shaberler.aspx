<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shaberler.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.shaberler" %>
...
<div class="banner-top">
	<div class="container">
		<h3 >Haberler</h3>
		<h4><a href="main.aspx">Anasayfa</a><label>/</label>Haberler</h4>
		<div class="clearfix"> </div>
	</div>
</div>
<!-- typography -->
<div class="typrography">
	 <div class="container">
		   ...
		   <asp:Image ID="Image3" runat="server" ImageAlign="Middle" ImageUrl="~/arkaplan/haberler_banner.png" Width="1127px" />
		<div class="main-icerik">
			<div class="spec ">
                <asp:Label ID="Label2" runat="server" Text="Başlık" Font-Size="XX-Large" BorderStyle="Groove" Font-Names="COCOGOOSE" BackColor="#FAB005" ForeColor="White" Width="900px"></asp:Label><br />
				...
				<asp:Label ID="Label7" runat="server" Text="Tarih" BorderStyle="Outset"></asp:Label>
				<br /><hr />
				<asp:Label ID="Label3" runat="server" Text="İçerik" Font-Names="Arial Narrow" Font-Size="Large" ></asp:Label><br /><hr />
                <asp:Image ID="Image1" runat="server" />
				<asp:Label ID="Label4" runat="server" Text="İçerik Yazarı:" Font-Bold="True" ></asp:Label><br />
				<asp:Label ID="Label8" runat="server" Text="Yazar Adı" Font-Bold="True" Font-Italic="True" ></asp:Label><br /><hr />
				</div>
		</div>
         <asp:Image ID="Image2" runat="server" ImageUrl="~/arkaplan/haberler_banner.png" Width="1127px" />
         <div class="spec "
			 <div class="col-md-6">
				<nav>
				  <ul class="pagination">
					<li class="disabled"><a href="#" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
					<li class="active"><a href="shaberler.aspx">1 <span class="sr-only">(current)</span></a></li>
					<li><a href="shaberler2.aspx">2</a></li>
					<li><a href="shaberler3.aspx">3</a></li>
					<li><a href="shaberler4.aspx#">4</a></li>
					<li><a href="shaberler5.aspx">5</a></li>
					<li><a href="shaberler6.aspx">6</a></li>
					<li><a href="shaberler7.aspx">7</a></li>
					<li><a href="shaberler8.aspx">8</a></li>
					<li><a href="shaberler9.aspx">9</a></li>
					<li><a href="shaberler10.aspx">10</a></li>
					<li><a href="shaberler11.aspx">11</a></li>
					<li><a href="shaberler12.aspx">12</a></li>
					<li><a href="shaberler13.aspx">13</a></li>
					<li><a href="shaberler14.aspx" aria-label="Next"><span aria-hidden="true">»</span></a></li>
				 </ul>
			   </nav>
