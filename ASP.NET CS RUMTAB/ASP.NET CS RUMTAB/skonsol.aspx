<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="skonsol.aspx.cs" Inherits="ASP.NET_CS_RUMTAB.skonsol" %>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="skonsol.aspx"><img class="first-slide" src="images/ba1.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="spckey.aspx"><img class="second-slide " src="images/ba.jpg" alt="Second slide"></a>
...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			...
			<h6>XBox</h6>
			<p>Gamepass ve Oyun Anahtarları</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="main.aspx">
								...
								<a href="#" data-toggle="modal" data-target="#myModal1" class="haber_ekle-img">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="36" data-name="Baby Oil" data-summary="summary 36" data-price="6.00" data-quantity="1" data-image="images/of36.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="37" data-name="Soap" data-summary="summary 37" data-price="4.50" data-quantity="1" data-image="images/of37.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<asp:TextBox ID="TextBox6" runat="server" ReadOnly="True" Width="225px"></asp:TextBox>
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="38" data-name="Hair Gel" data-summary="summary 38" data-price="3.50" data-quantity="1" data-image="images/of38.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="39" data-name="Lotion" data-summary="summary 39" data-price="0.80" data-quantity="1" data-image="images/of39.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<a href="#" data-toggle="modal" data-target="#myModal5" class="haber_ekle-img">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="40" data-name="Shower Gel" data-summary="summary 40" data-price="6.00" data-quantity="1" data-image="images/of40.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="41" data-name="Hair Color" data-summary="summary 41" data-price="4.50" data-quantity="1" data-image="images/of41.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="42" data-name="Wipes" data-summary="summary 42" data-price="3.50" data-quantity="1" data-image="images/of42.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="43" data-name="Essential Oils" data-summary="summary 43" data-price="0.80" data-quantity="1" data-image="images/of43.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<a href="#" data-toggle="modal" data-target="#myModal9" class="haber_ekle-img">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="44" data-name="Cream" data-summary="summary 44" data-price="6.00" data-quantity="1" data-image="images/of44.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="45" data-name="Hair Color" data-summary="summary 45" data-price="4.50" data-quantity="1" data-image="images/of45.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="46" data-name="Baby Care" data-summary="summary 46" data-price="3.50" data-quantity="1" data-image="images/of46.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="47" data-name="Lotion" data-summary="summary 47" data-price="0.80" data-quantity="1" data-image="images/of47.png">Sepete Ekle</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="36" data-name="Baby Oil" data-summary="summary 36" data-price="1.50" data-quantity="1" data-image="images/of36.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="37" data-name="Soap" data-summary="summary 37" data-price="9.00" data-quantity="1" data-image="images/of37.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="38" data-name="Hair Gel" data-summary="summary 38" data-price="2.00" data-quantity="1" data-image="images/of38.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="39" data-name="Lotion " data-summary="summary 39" data-price="3.50" data-quantity="1" data-image="images/of39.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="40" data-name="Shower Gel" data-summary="summary 40" data-price="0.70" data-quantity="1" data-image="images/of40.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="41" data-name="Hair Color" data-summary="summary 41" data-price="0.70" data-quantity="1" data-image="images/of41.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="42" data-name="Wipes" data-summary="summary 42" data-price="1.00" data-quantity="1" data-image="images/of42.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="43" data-name="Essential Oils" data-summary="summary 43" data-price="3.50" data-quantity="1" data-image="images/of43.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="44" data-name="Cream" data-summary="summary 44" data-price="1.50" data-quantity="1" data-image="images/of44.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="45" data-name="Hair Color" data-summary="summary 45" data-price="0.70" data-quantity="1" data-image="images/of45.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="46" data-name="Baby Care" data-summary="summary 46" data-price="1.00" data-quantity="1" data-image="images/of46.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="47" data-name="Lotion" data-summary="summary 47" data-price="3.50" data-quantity="1" data-image="images/of47.png">Sepete Ekle</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
